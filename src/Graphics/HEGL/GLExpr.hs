...
data GLExpr :: ShaderDomain -> * -> * where
    ...
    HostVar :: GLType t =>
        ExprID -> HostVar t -> GLExpr HostDomain t
    Inp :: GLPrim t => 
...
data HostVar t where
    IOFloat :: IOVarID -> HostVar Float
    IODouble :: IOVarID -> HostVar Double
    IOInt :: IOVarID -> HostVar Int
    IOUInt :: IOVarID -> HostVar UInt
    IOBool :: IOVarID -> HostVar Bool
